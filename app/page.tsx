  ...
  return (
    <div className="theme-page-shell">
      <main className="space-y-5 px-4 py-5 sm:px-6">
        <section className="theme-panel-strong rounded-[28px] p-6 shadow-[0_20px_60px_rgba(20,33,61,0.08)]">
          <div className="grid gap-8 xl:grid-cols-[minmax(0,1.2fr)_340px]">
            <div className="min-w-0">
                    ...
                    className={[
                      ...
                      action.variant === "primary"
                        ...
                        : action.variant === "success"
                          ? "bg-[#17b466] text-white hover:opacity-90"
                          : "theme-panel text-[var(--text-primary)] hover:bg-[var(--panel-background-soft)]",
                    ].join(" ")}
                  >
              ...
              <div className="mt-8 grid gap-4 border-t border-[var(--panel-border)] pt-6 sm:grid-cols-3">
            ...
            <aside className="flex flex-col justify-between border-l border-[var(--panel-border)] pl-0 xl:pl-8">
        ...
        <section className="theme-panel-strong rounded-[24px] p-5 shadow-[0_14px_40px_rgba(20,33,61,0.06)]">
          <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_300px]">
                ...
                {recentApps.length > 0 ? (
                  recentApps.map((app) => (
                    ...
                    >
                      ...
                      <div className="hidden shrink-0 text-right text-xs text-[var(--text-muted)] sm:block">
                        <div>{app.owner}</div>
                        <div className="mt-1">{app.records} 条数据</div>
                      </div>
                      <ArrowRight className="h-4 w-4 shrink-0 text-[var(--text-subtle)] transition-transform group-hover:translate-x-0.5" />
                    </Link>
                  ))
                ) : (
            ...
            <aside className="border-t border-[var(--panel-border)] pt-6 xl:border-l xl:border-t-0 xl:pl-8 xl:pt-0">
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-semibold text-[var(--text-primary)]">
                  快捷入口
                </h2>
...
function SummaryCard({
  ...
  const toneClassName = {
    ...
    violet: "bg-[rgba(115,92,194,0.14)] text-[#735cc2]",
  }[tone];
