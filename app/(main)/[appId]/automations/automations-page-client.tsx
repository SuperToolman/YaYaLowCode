...
export function AutomationsPageClient({ appId }: AutomationsPageClientProps) {
  ...
  return (
    <div className="mx-auto flex w-full flex-col gap-4 text-[var(--color-text-primary)]">
      <section className="flex flex-col gap-4 border-b border-[var(--color-border)] pb-5 lg:flex-row lg:items-end lg:justify-between">
        <div className="min-w-0">
          <div className="inline-flex items-center gap-2 rounded-lg bg-[var(--color-primary-soft)] px-3 py-1 text-xs font-medium text-[var(--color-primary)]">
            <ListIcon />
            集成自动化
          </div>
