...
import { getAppBusinessContext, setDefaultNavigationEntry, updateApp, updateAppBusinessContext } from "@/features/application/api";
import {
  getAppForms,
  getAppNavigation,
  getAppResource,
...
export default function AppSettingsPage({
  ...
  useEffect(() => {
    let cancelled = false;
    void getAppBusinessContext<typeof businessContext>(appId)
      .then((context) => {
        if (!cancelled) setBusinessContext(context);
      })
      .catch(() => undefined);
  ...
  async function saveBusinessContext() {
    setIsSaving(true);
    try {
      setBusinessContext(await updateAppBusinessContext<typeof businessContext>(appId, businessContext));
