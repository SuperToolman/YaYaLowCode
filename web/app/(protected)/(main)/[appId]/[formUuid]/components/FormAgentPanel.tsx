...
import { AgentMarkdown, AgentMessage, AgentMessageComposer } from "@features/agent-assistant/components";
...
export function FormAgentPanel({
  ...
  useEffect(() => {
    // Reset the local agent session when the selected agent changes.
