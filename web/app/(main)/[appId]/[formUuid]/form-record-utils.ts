...
type FormRecord = { id: string; formUuid?: string; schemaVersion?: number; data: Record<string, unknown>; createdBy: string; submitterOrganization?: string | null; updatedBy?: string; createdAt: string; updatedAt: string };
