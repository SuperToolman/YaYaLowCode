        ...
        <div className="h-full overflow-auto">
          <table className="min-w-[1080px] w-full table-fixed text-left text-sm">
            <thead className="sticky top-0 z-10 bg-[var(--color-bg-subtle)] text-xs font-medium text-[var(--color-text-secondary)]">
              <tr>
                <th className="w-[18%] border-b border-[var(--color-border)] px-4 py-3">
                  配置文件名称
                </th>
                <th className="w-[17%] border-b border-[var(--color-border)] px-4 py-3">
                  供应商名称
                </th>
                <th className="w-[15%] border-b border-[var(--color-border)] px-4 py-3">
                  对话模型
                </th>
                <th className="w-[14%] border-b border-[var(--color-border)] px-4 py-3">
                  人格名称
                </th>
                <th className="w-[11%] border-b border-[var(--color-border)] px-4 py-3">
                  联网搜索能力
                </th>
                <th className="w-[17%] border-b border-[var(--color-border)] px-4 py-3">
                  人格能力
                </th>
                <th className="w-[8%] border-b border-[var(--color-border)] px-4 py-3">
                  操作
                </th>
              </tr>
            </thead>
            <tbody>
              {profiles.map((item) => {
                ...
                return (
                  <tr
                    key={item.id}
                    className="hover:bg-[var(--color-control-soft-hover)]"
                  >
              ...
              {profiles.length === 0 ? (
                <tr>
                  <td
                    colSpan={7}
                    className="h-48 text-center text-[var(--color-text-secondary)]"
                  >
                    暂无配置文件，点击“添加配置文件”创建。
                  </td>
                </tr>
