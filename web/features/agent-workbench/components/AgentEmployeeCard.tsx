...
export function AgentEmployeeCard({
  ...
  return (
    ...
    >
      <MySurface
        className={`flex flex-col items-center gap-1 px-1.5 py-2.5 transition-colors ${selected ? "text-accent" : "text-foreground"}`}
      >
        {avatarFailed ? (
        ...
        <span className="line-clamp-2 w-full break-words text-center text-[11px] font-medium">
          {employee.name}
        </span>
      </MySurface>
    </button>
